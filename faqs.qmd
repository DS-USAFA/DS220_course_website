...
## Positive Comments from Past Students
...
## What's the Deal with this Grading System?
...
|  |  |
|------------------------------------|------------------------------------|
| ![](images/course_grades_spr26.png){width="298"} | ![](images/course_grades_fall25.png){width="267"} |
| ![](images/course_grades_spr25.png){width="287"} |  |

: No one ended up on academic probation at prog solely due to this course in past semesters. The Ds and Fs in past semester final grades represent students who did not complete numerous assignments and/or did not take advantage of the opportunity to reattempt core competency standards throughout the semester and struggled with content all semester.
...
::: {.callout-note collapse="true" icon="false"}
## What are the Cutlines for HW and Reading Guide Scores?
...
::: {.callout-tip collapse="true" icon="false"}
## Concern from Data Science/Math/Ops Research Majors
